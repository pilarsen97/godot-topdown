...
### Битовые значения (если правишь .tscn руками)
В инспекторе ставишь галочки — Godot сам считает число. Если видишь
в .tscn `collision_layer = 4` — это **слой 3**, а не «слой 4».
Соответствие: `Layer N → value 2^(N-1)`.

| Слой | Bit | Value | Имя в нашем проекте |
|---|---|---|---|
| 1 | 0 | 1 | player |
| 2 | 1 | 2 | enemy |
| 3 | 2 | 4 | player_hitbox |
...
Несколько слоёв сразу — сумма (player + player_hitbox = 1 + 4 = 5).
